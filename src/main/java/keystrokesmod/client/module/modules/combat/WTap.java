...
public class WTap extends Mod {
    ...
    private final DoubleSliderSetting postDelay = new DoubleSliderSetting("Post delay (MS)", this, 25.0, 55.0, 1.0, 500.0, 1.0);
    private final SliderSetting chance = new SliderSetting("Chance %", this, 100.0, 0.0, 100.0, 1.0);
    private final SliderSetting range = new SliderSetting("Range: ", this, 3.0, 1.0, 6.0, 0.05);
