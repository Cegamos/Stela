...
public class RangeSliderComponent extends Component {
    ...
    @Override
    public void draw() {
        Gui.drawRect(this.module.category.getX() + 4, this.module.category.getY() + this.moduleStartY + 11, this.module.category.getX() - 4 + this.module.category.getWidth(), this.module.category.getY() + this.moduleStartY + 11 + 4, -12302777);
        ...
        Gui.drawRect(startToDrawFrom, this.module.category.getY() + this.moduleStartY + 11, finishDrawingAt, this.module.category.getY() + this.moduleStartY + 11 + 4, Theme.getMainColor().getRGB());
        Gui.drawRect(middleThing, this.module.category.getY() + this.moduleStartY + 11 - 1, middleThing + ((middleThing % 2 == 0) ? 2 : 1), this.module.category.getY() + this.moduleStartY + 11 + 4 + 1, -14869217);
        GL11.glPushMatrix();
        GL11.glScaled(0.5, 0.5, 0.5);
        mc.fontRendererObj.drawStringWithShadow(this.doubleSlider.getName() + ": " + this.doubleSlider.getInputMin() + ", " + this.doubleSlider.getInputMax(), (float)(int)((this.module.category.getX() + 4) * 2.0f), (float)(int)((this.module.category.getY() + this.moduleStartY + 3) * 2.0f), -1);
        GL11.glPopMatrix();
    }
    ...
    public boolean isVisible() {
        return this.doubleSlider.canDisplay();
    }
