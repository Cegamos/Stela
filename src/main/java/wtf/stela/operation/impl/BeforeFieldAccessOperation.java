...
import wtf.stela.annotations.BeforeFieldAccess;
...
public class BeforeFieldAccessOperation implements Operation {
    ...
    public static BeforeFieldAccess getAnnotation(MethodNode method) {
        ...
        for (AnnotationNode annotation : ASMUtil.getAnnotations(method)) {
            if (annotation.desc.equals("Lwtf/stela/annotations/BeforeFieldAccess;")) {
                ...
                return new BeforeFieldAccess() {
                    @Override public Class<? extends Annotation> annotationType() { return BeforeFieldAccess.class; }
